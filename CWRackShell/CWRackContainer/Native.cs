...
namespace CWRackContainer
{
    public class Native
    {
        ...
        public static extern IntPtr CreateWindowEx(uint dwExStyle, ushort regClassResult, string lpWindowName, uint dwStyle, int x, int y, int nWidth, int nHeight, IntPtr hWndParent, IntPtr hMenu, IntPtr hInstance, IntPtr pvParam);
